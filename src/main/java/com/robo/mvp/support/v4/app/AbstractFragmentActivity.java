...
/**
 * Provides the base class for implementing {@link FragmentActivity}.
 *
 * @param <TModel> Model type
 * @author robo-admin
 */
public abstract class AbstractFragmentActivity<TModel> extends FragmentActivity implements
        View<TModel>, com.robo.mvp.LoaderManagerProvider, ContextProvider {
    ...
    /**
     * Called after the model has been set to the view. Subclass can override this method to register
     * event handlers or so on.
     *
